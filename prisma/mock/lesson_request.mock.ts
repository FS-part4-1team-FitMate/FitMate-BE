...
export const LESSON_REQUESTS = [
  {
    ...
    startDate: convertKstToUtc(2025, 1, 18, 10, 0, 0),
    endDate: convertKstToUtc(2025, 1, 20, 18, 0, 0),
    lessonCount: 3,
    lessonTime: 24,
    quoteEndDate: convertKstToUtc(2025, 1, 17, 23, 59, 59),
    locationType: LocationType.ONLINE,
    postcode: null,
    roadAddress: null,
    detailAddress: null,
    status: LessonRequestStatus.EXPIRED,
    createdAt: convertKstToUtc(2025, 1, 17, 9, 0, 0),
    updatedAt: convertKstToUtc(2025, 1, 17, 9, 0, 0),
  },
  {
    ...
    startDate: convertKstToUtc(2025, 1, 24, 10, 0, 0),
    endDate: convertKstToUtc(2025, 1, 28, 18, 0, 0),
    lessonCount: 5,
    lessonTime: 40,
    quoteEndDate: convertKstToUtc(2025, 1, 23, 23, 59, 59),
    locationType: LocationType.OFFLINE,
    postcode: '13529',
    roadAddress: '경기 성남시 분당구 판교역로 166',
    detailAddress: '101호',
    status: LessonRequestStatus.COMPLETED,
    createdAt: convertKstToUtc(2025, 1, 20, 9, 0, 0),
    updatedAt: convertKstToUtc(2025, 1, 24, 0, 0, 0),
  },
  {
    ...
    lessonType: LessonType.FITNESS,
    lessonSubType: LessonSubType.PILATES,
    startDate: convertKstToUtc(2025, 2, 7, 10, 0, 0),
    endDate: convertKstToUtc(2025, 2, 7, 18, 0, 0),
    lessonCount: 5,
    lessonTime: 40,
    quoteEndDate: convertKstToUtc(2025, 2, 6, 23, 59, 59),
    locationType: LocationType.OFFLINE,
    postcode: '13529',
    roadAddress: '경기 성남시 분당구 판교역로 166',
    detailAddress: '101호',
    status: LessonRequestStatus.PENDING,
    createdAt: convertKstToUtc(2025, 1, 31, 11, 0, 0),
    updatedAt: convertKstToUtc(2025, 1, 31, 11, 0, 0),
  },
  {
    ...
    startDate: convertKstToUtc(2025, 1, 23, 11, 0, 0),
    endDate: convertKstToUtc(2025, 1, 24, 19, 0, 0),
    lessonCount: 3,
    lessonTime: 60,
    quoteEndDate: convertKstToUtc(2025, 1, 22, 23, 59, 59),
    locationType: LocationType.OFFLINE,
    postcode: '12345',
    roadAddress: '서울 강남구 테헤란로 123',
    detailAddress: '202호',
    status: LessonRequestStatus.EXPIRED,
    createdAt: convertKstToUtc(2025, 1, 18, 11, 0, 0),
    updatedAt: convertKstToUtc(2025, 1, 18, 11, 0, 0),
  },
  {
    ...
    startDate: convertKstToUtc(2025, 1, 15, 11, 0, 0),
    endDate: convertKstToUtc(2025, 1, 16, 19, 0, 0),
    lessonCount: 2,
    lessonTime: 16,
    quoteEndDate: convertKstToUtc(2025, 1, 14, 23, 59, 59),
    locationType: LocationType.OFFLINE,
    postcode: '67890',
    roadAddress: '부산 해운대구 센텀중앙로 55',
    detailAddress: '303호',
    status: LessonRequestStatus.COMPLETED,
    createdAt: convertKstToUtc(2025, 1, 12, 11, 0, 0),
    updatedAt: convertKstToUtc(2025, 1, 12, 11, 0, 0),
  },
  {
    ...
    lessonSubType: LessonSubType.TENNIS,
    startDate: convertKstToUtc(2025, 1, 18, 10, 0, 0),
    endDate: convertKstToUtc(2025, 1, 18, 18, 0, 0),
    lessonCount: 1,
    lessonTime: 8,
    quoteEndDate: convertKstToUtc(2025, 1, 17, 23, 59, 59),
    locationType: LocationType.ONLINE,
    ...
    detailAddress: null,
    status: LessonRequestStatus.COMPLETED,
    createdAt: convertKstToUtc(2025, 1, 17, 10, 0, 0),
  ...
  },
  {
    ...
    lessonCount: 5,
    lessonTime: 40,
    quoteEndDate: convertKstToUtc(2025, 2, 5, 23, 59, 59),
    locationType: LocationType.ONLINE,
    postcode: null,
    roadAddress: null,
    detailAddress: null,
  ...
  },
  {
    ...
    lessonCount: 4,
    lessonTime: 90,
    quoteEndDate: convertKstToUtc(2025, 2, 4, 23, 59, 59),
    locationType: LocationType.OFFLINE,
    postcode: '54321',
  ...
  },
  {
    ...
    lessonCount: 3,
    lessonTime: 80,
    quoteEndDate: convertKstToUtc(2025, 2, 25, 23, 59, 59),
    locationType: LocationType.ONLINE,
    postcode: null,
    roadAddress: null,
    detailAddress: null,
  ...
  },
  {
    ...
    lessonCount: 5,
    lessonTime: 60,
    quoteEndDate: convertKstToUtc(2025, 1, 28, 23, 59, 59),
    locationType: LocationType.OFFLINE,
    postcode: '55555',
